(function () {
  ...
  const STRINGS = {
    en: {
      ...
      "settings.activation": "Browser Pro activation",
      "settings.activationLead": "Pay on ledebe.com/pricing, then paste the activation code you receive. Ledebe servers do not store your custom words.",
      "settings.activationCode": "Activation code",
      "settings.activationCodeLabel": "Activation code",
      "settings.activationRedeem": "Activate Pro",
      "settings.activationMissing": "Enter your activation code.",
      "settings.activationDone": "Browser Pro is active on this browser.",
      "settings.activationUpgrade": "Upgrade to Pro",
      "settings.activationActiveLead": "Pro is active on this browser. Ledebe stores billing and entitlement status only; your custom words stay on this device.",
      "settings.activationStatus": "Status",
      "settings.activationActive": "Active",
      "settings.activationValidUntil": "Session valid until",
      "settings.activationRefresh": "Check activation",
      "settings.activationChecked": "Activation is still active.",
      "settings.activationRemove": "Remove activation from this browser",
      "settings.activationRemoved": "Activation removed from this browser.",
